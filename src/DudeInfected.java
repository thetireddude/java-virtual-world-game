...
public class DudeInfected extends Dude {
    ...
    public static DudeInfected createInfected(String id, Point position, List<PImage> images, double actionPeriod,
                                       double animationPeriod, int resourceLimit){
        return new DudeInfected(id, position, images, actionPeriod, animationPeriod, resourceLimit);
    }
